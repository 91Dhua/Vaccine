...
| 预览页 | 展示任务编号、接种日期、疫苗、品牌、剂型、接种方式、剂量、剂次 | 给用户做最终确认，不再展示间隔信息 |
...
| 模块 | 前端展示/交互 | 后端/业务逻辑 |
|---|---|---|
| 列表列展示 | 展示任务ID、疫苗、品牌、剂型、接种方式、剂量、剂次、接种日期、目标猪只、创建/执行信息 | 返回当前任务状态与核心快照 |
...
| 猪只执行页 | 按房间/栏位进入接种执行列表 | 使用任务快照展示疫苗、品牌、剂型、接种方式、剂量等信息 |
